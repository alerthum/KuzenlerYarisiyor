# Aşama 08 — Semantik tekrar ve kapasite

## Amaç

Çözüm grafiği, iskelet, bilgi sırası, düşünme yolu ve çeldirici planı benzerliğini ölç.
Aynı çözümün sayı/isim değişmiş varyasyonlarını aynı kabul et.
60 ardışık oturum ve farklı seed simülasyonları çalıştır.
