...
export const RUNTIME_CONFIG = Object.freeze({
  ...
  "contentVersion": "13.14.0-evidence-backed-science-engine",
  "releaseVersion": "13.14.0-evidence-backed-science-engine",
  "aiProvider": "local",
  "git": {
  ...
  "features": {
    ...
    "pwa": true,
    "qualityPilotMode": false,
    "controlledLaunchPilotMode": true,
    "controlledLaunchPilotVersion": "PHASE5I_PILOT_1",
