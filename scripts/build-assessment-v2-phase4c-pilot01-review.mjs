...
const reviewPayload = {
  ...
  batchId: 'GRADE8_TURKISH_PILOT_01_REVIEW_12', decision: 'HUMAN_REVIEW_REQUIRED',
  productReady: false, gameAdaptationAllowed: false,
  selection: { itemCount: 12, outcomeCount: 8, answerCounts },
...
const reviewJsonPath = path.join(reportDir, 'assessment-engine-v2-phase4c-grade8-turkish-review12.json');
...
const html = `<!doctype html><html lang="tr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>8. Sınıf Türkçe Pilot-01 İnceleme 12</title><style>
