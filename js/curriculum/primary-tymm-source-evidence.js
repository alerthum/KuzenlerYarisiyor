...
export const PRIMARY_TYMM_SOURCE_EVIDENCE_AUDIT=Object.freeze({
  ok:PRIMARY_TYMM_SOURCE_EVIDENCE.length===5&&PRIMARY_TYMM_SOURCE_EVIDENCE.every(row=>row.status==='LOCAL_AUTHORITATIVE_EVIDENCE_VERIFIED'&&/^[a-f0-9]{64}$/.test(row.sha256)),
  metrics:Object.freeze({sourceCount:PRIMARY_TYMM_SOURCE_EVIDENCE.length,gradeCount:3,courseCount:5,localEvidenceCount:PRIMARY_TYMM_SOURCE_EVIDENCE.length})
});
