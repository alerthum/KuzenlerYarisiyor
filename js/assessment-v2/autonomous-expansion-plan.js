...
export function buildAssessmentV2AutonomousExpansionPlan(portfolio=ASSESSMENT_V2_PRODUCTION_PORTFOLIO,queue=ASSESSMENT_V2_HUMAN_REVIEW_QUEUE){
  ...
  const backlog=Object.freeze([
    Object.freeze({order:1,id:'calibrate-risk-sample',kind:'HUMAN_REVIEW',scope:`${portfolio.summary.activeEngineCellCount} aktif motor için risk tabakalı örneklem`,reason:`${queue.metrics.pending} görevin tümünü sırayla okumadan önce her format, kazanım ve zorluk katmanından dengeli örneklem onaylanmalı.`,count:95}),
  ...
  return Object.freeze({schemaVersion:'2.0',generatedAt:new Date().toISOString(),target:portfolio.target,status:'GRADE5_AND_LGS_CORE_COMPLETE_AUTONOMOUS_REVIEW_AND_EXPANSION_PLAN',productReady:false,gameAdaptationAllowed:false,
